import './app.css';
import * as Palette from './components/ColorPalette';
import * as Pad from './components/Pad';
import { getButtonData, setButtonData } from './utils';
...
// Render components and wire them together
Pad.render();
Pad.onSelectionChange((st) => {
  console.log({ st });
});
Palette.render();
